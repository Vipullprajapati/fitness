        ...
        <div className="relative max-w-7xl mx-auto px-4 py-24 sm:px-6 lg:px-8">
          <div className="max-w-xl sm:mt-1 space-y-8">
            <h1 className="text-5xl font-extrabold tracking-tight sm:text-6xl">
              <span className="text-orange-500">Vipul Prajapati</span>
            </h1>
            <p className="text-xl text-gray-300">
              I am Vipul Prajapati I have 7 years of progressive
              experience in end-to-end store operations, staff management, and
              overseeing all ground-level retail activities. Worked with reputed
              industry leaders, including Reliance, Blinkit, and Flipkart
            </p>
